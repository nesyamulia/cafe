...
@section('main')
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a href="{{route('user.create') }}" class="badge badge-sm bg-gradient-primary mb-3 fs-6">Add New Item</a>
              <h6>Users</h6>
            </div>
      ...
      <input type="hidden" id="psn" class="form-control" value="@isset($pesan){{$pesan}}@endisset" />
      <script>
