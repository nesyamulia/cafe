      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a href="{{route('menu.create') }}" class="badge badge-sm bg-gradient-primary mb-3 fs-6">Add New Item</a>
              <h6>Menus</h6>
            </div>
                ...
                <table class="table align-items-center mb-0" id="data">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">1st Photo</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">2nd Photo</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">3rd Photo</th>
